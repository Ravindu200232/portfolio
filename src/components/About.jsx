        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            <motion.button
              ...
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/13ZIaFD0Y2pz1M_tObs_XHX0qdi-2wx6J/view?usp=drive_link",
                  "_blank"
                )
              }
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() =>
                window.open("https://www.linkedin.com/in/ravindu2232", "_blank")
              }
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() =>
                window.open("https://github.com/Ravindu200232/", "_blank")
              }
            >
        ...
        >
          ...
          >
            ...
            >
              ...
              <span>
                I&apos;m a 3rd-year Software Engineering undergraduate at SLIIT
                University, passionate about web technologies and solving
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🌐</span>
              <span>
                I create original and responsive websites from scratch,
                transforming ideas into fully functional web apps.
              </span>
            </motion.li>
            <motion.li
              className="flex items-start"
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🛠</span>
              <span>
                My core tech stack includes MERN (MongoDB, Express, React,
                Node.js) along with Next.js for server-side rendering and
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🌳</span>
              <span>
                I also experiment with Three.js to bring 3D elements to life on
                the web – still learning, but loving the journey.
              </span>
            </motion.li>
            <motion.li
              className="flex items-start"
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🚀</span>
              <span>
                I thrive on learning, collaboration, and building solutions that
                are both technically solid and creatively crafted.
              </span>
            </motion.li>
          </motion.ul>
        </motion.div>
